 ...
 * 
 *  File: \js\game\scenes\about\aboutAudioModule.js
 * 
 *  Last Revision:  19-03-2018
 *  
 *  Purpose:  
 *      handles the audio for the game state about
 * 
 * 
*/
...
( function( alienInvasion ){
    ...
    // MODULE: aboutAudioModule( Phaser.Game ) void
    
    alienInvasion.aboutAudioModule = function( game ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'aboutAudioModule';                               // string
    ...
    // DONE MODULE: aboutAudioModule( Phaser.Game ) void
})( alienInvasion );
