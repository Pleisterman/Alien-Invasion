 ...
 * 
 *  File: \js\game\scenes\about\aboutBackgroundModule.js
 * 
 *  Last Revision:  24-03-2018
 * 
 *  Purpose:  
 *      draws the background for the game scene about
 * 
 * 
*/
...
( function( alienInvasion ){
    ...
    // MODULE: aboutBackgroundModule( Phaser.Game, module: audio ) void
    
    alienInvasion.aboutBackgroundModule = function( game, audio ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'aboutBackgroundModule';                          // string
    ...
    // DONE MODULE: aboutBackgroundModule( Phaser.Game, module: audio ) void
})( alienInvasion );
