 ...
 * 
 *  File: \js\game\scenes\about\aboutForegroundModule.js
 * 
 *  Last Revision:  19-03-2018
 *  
 *  Purpose:  
 *      draws the foreground for the scene about
 * 
 * 
*/
...
( function( alienInvasion ){
    ...
    // MODULE: aboutForegroundModule( Phaser.Game, module: audio ) void
    
    alienInvasion.aboutForegroundModule = function( game, audio ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'aboutForegroundModule';                          // string
        ...
        self.sprites = [                                                // json: sprites
            {                                                           // json: topBarOptions                
                ...
                'fileName'          :   self.imageUrl + 'gameAboutTopBar.png', // string
    ...
    // DONE MODULE: aboutForegroundModule( Phaser.Game, module: audio ) void
})( alienInvasion );
