...
( function( alienInvasion ){
    ...
    // MODULE: gameMenuBackgroundModule( Phaser.Game, module: audio ) void
    
    alienInvasion.gameMenuBackgroundModule = function( game, audio ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'gameMenuBackgroundModule';                       // string
        ...
        self.backgroundImage = {                                        // json: backgroundImage
            'assetId'           :   'gameMenuBackground',               // string
            'originalSize'      :   {
                'width'         :   0,
                'height'        :   0
            },
    ...
    // DONE MODULE: gameMenuBackgroundModule( Phaser.Game, module: audio ) void
})( alienInvasion );
