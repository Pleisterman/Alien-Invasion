 ...
 * 
 *  File: \js\game\scenes\highScores\highScoresForegroundModule.js
 * 
 *  Last Revision:  19-03-2018
 *  
 *  Purpose:  
 *      raws the foreground for the scene highScores
 * 
 * 
*/
...
( function( alienInvasion ){
    ...
    // MODULE: highScoresForegroundModule( Phaser.Game, module: audio ) void
    
    alienInvasion.highScoresForegroundModule = function( game, audio ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'highScoresForegroundModule';                     // string
        ...
        self.sprites = [                                                // json: sprites
            {                                                           // json: topBarOptions                
                ...
                'type'              :   'image',                        // string
                'height'            :   90,                             // integer: px
                'mobileHeight'      :   60,                             // integer: px
                'fileName'          :   self.imageUrl + 'highScoresTopBar.png', // string
                'phaserObject'      :   null                            // Phaser.Sprite
            },                                                          // done json: topBarOptions
            {                                                           // json: leftSideBarOptions
                'assetId'           :   'leftSideBar',                  // string: assetId
                'type'              :   'image',                        // string: type
                'width'             :   40,                            // integer: px width
                'mobileWidth'       :   10,                             // integer: px
                'fileName'          :   self.imageUrl + 'gameLeftBar.png', // string: fileName
                'phaserObject'      :   null                            // Phaser.Sprite
    ...
    // DONE MODULE: highScoresForegroundModule( Phaser.Game, module: audio ) void
})( alienInvasion );
