 ...
 * 
 *  File: \js\game\scenes\options\optionsAudioModule.js
 * 
 *  Last Revision:  17-03-2018
 *  
 *  Purpose:  
 *      handles the audio for the scene options
 * 
 * 
*/
...
( function( alienInvasion ){
    ...
    // MODULE: optionsAudioModule( Phaser.Game ) void
    
    alienInvasion.optionsAudioModule = function( game ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object
        self.MODULE = 'optionsAudioModule';                             // string
        self.debugOn = true;                                            // boolean
        self.game = game;                                               // Phaser.game
        self.audioUrl = alienInvasion.config['audioUrl'];               // string
        self.music = [                                                  // json: music
            {                                                           
                'id' :                  'optionsBackground01',
                'fileNames'     :   [
        ...
        // FUNCTION: playEffect( string: effectId ) void
            ...
            if( effect ){
                ...
                // debug
                self.debug( 'optionsAudio effect not found: ' + effectId );
    ...
    // DONE MODULE: optionsAudioModule( Phaser.Game ) void
})( alienInvasion );
